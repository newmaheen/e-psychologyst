...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/user')}}/css/main.css" class="color-switcher-link">
        ...
        <section class="intro_section page_mainslider ds">
            <div class="flexslider">
                <ul class="slides">
                    ...
                    <li>
                        <img src="{{asset('/user')}}/images/slide01.jpg" alt="">
                        <div class="container">
                            <div class="row">
                ...
                <div class="row columns_padding_0 columns_margin_0 fontsize_16">
                    <div class="col-md-3 col-sm-6">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/relationship.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/mental.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6 clear-sm">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/feelings.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/conflicting.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6 clear-lg clear-md clear-sm">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/meditation.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/depression.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6 clear-sm">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/mind.png" alt="" />
                            <h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="with_padding text-center teaser hover_shadow">
                            <img src="{{asset('/user')}}/images/service-icons/relaxation.png" alt="" />
                            <h4>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-push-6 text-center">
                        ...
                        <img src="{{asset('/user')}}/images/signature.png" alt="" />
                    </div>
                    <div class="col-md-6 col-md-pull-6 text-center bottommargin_0">
                        <img src="{{asset('/user')}}/images/person.png" alt="" class="top-overlap" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-4 text-center">
                        <article class="vertical-item content-padding post format-standard with_shadow">
                            ...
                            <div class="item-media entry-thumbnail">
                                <img src="{{asset('/user')}}/images/blog_post1.jpg" alt="">
                            </div>
                    ...
                    <div class="col-md-4 text-center">
                        <article class="vertical-item content-padding post format-standard with_shadow">
                            ...
                            <div class="item-media entry-thumbnail">
                                <img src="{{asset('/user')}}/images/blog_post2.jpg" alt="">
                            </div>
                    ...
                    <div class="col-md-4 text-center">
                        <article class="vertical-item content-padding post format-standard with_shadow">
                            ...
                            <div class="item-media entry-thumbnail">
                                <img src="{{asset('/user')}}/images/blog_post3.jpg" alt="">
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="tab-content padding_0">
                            ...
                            <div class="tab-pane fade in active" id="tab1">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <a href="http://player.vimeo.com/video/1084537" class="embed-placeholder">
                                        <img src="{{asset('/user')}}/images/video_tab1.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="tab2">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <a href="http://player.vimeo.com/video/1084537" class="embed-placeholder">
                                        <img src="{{asset('/user')}}/images/video_tab2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="tab3">
                                <div class="embed-responsive embed-responsive-16by9">
                                    <a href="http://player.vimeo.com/video/1084537" class="embed-placeholder">
                                        <img src="{{asset('/user')}}/images/video_tab3.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
                        ...
                        <form class="contact-form row columns_margin_bottom_40 topmargin_60" method="post" action="{{ route('new.appointment') }}">
                            @csrf
                                ...
                                <div class="contact-form-subject">
                                    ...
                                    <select aria-required="true" id="doctor_id" name="doctor_id" class="choice empty form-control">
                                        ...
                                        @foreach( $doctors as $d)
                                            <option value="{{ $d->id }}">{{ $d->name }},{{$d->last_degree}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
