        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-5 col-6 text-right m-b-30">
                    <a href="{{route('doctor.edit')}}"class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Edit Profile</a>
                </div>
            </div>
                                    ...
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            ...
                                            <li>
                                                ...
                                                <span class="text">{{$doctor->last_degree}}</span>
                                            </li>
                                            <li>
                                             ...
                                             <li>
                                                ...
                                                <div class="experience-content">
                                                    <div class="timeline-content">
                                                        ...
                                                        <span class="time">{{$education->passing_year}}</span>
                                                    </div>
                                                </div>
                                            </li>
                                            @endforeach
                                    ...
                                    <div class="experience-box">
                                        <ul class="experience-list">
                                            @foreach($doctor->experiences as $experience)
                                                ...
                                                <div class="experience-content">
                                                    <div class="timeline-content">
                                                        <a href="#/" class="name">{{$experience->position}}</a>
                                                        <div>{{$experience->company}}</div>
                                                        <span class="time">{{$experience->from}} - @if($experience->to != null ){{$experience->to}}@else Present @endif</span>
                                                    </div>
                                                </div>
                                            </li>
                                            @endforeach
