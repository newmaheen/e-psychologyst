        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-8 col-6">
                    <h4 class="page-title">Yor Schedule History</h4>
                </div>
                            ...
                            <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        ...
                                        <h2><a href="#"><?php echo e($schedule->day); ?></a></h2>
                                    </td>
                                    <td><?php echo e($schedule->time_from); ?></td>
                                    <td><?php echo e($schedule->time_to); ?></td>
                                    <td class="text-right">
...
<?php echo $__env->make('doctor.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Psychologist\resources\views/doctor/schedule/index.blade.php ENDPATH**/ ?>