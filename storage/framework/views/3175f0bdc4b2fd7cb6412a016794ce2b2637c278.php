        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-8 col-6">
                    <h4 class="page-title">All Doctor Requests</h4>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="btn btn-dark">
                                            <a href="<?php echo e(route('approve-doctor',$doctor->id)); ?>">Approve</a>
                                        </div>
                                    </td>
                                </tr>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Psychologist\resources\views/admin/doctors/requests.blade.php ENDPATH**/ ?>