            ...
            <div class="col-md-6 col-sm-2 text-center">
                ...
                <nav class="mainmenu_wrapper">
                    <ul class="mainmenu nav sf-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('therapy')); ?>">Therapy</a>
                            <div class="mega-menu">
                        ...
                        <li>
                            <a href="<?php echo e(route('tutorial')); ?>">Tutorial</a>
                        ...
                        <!-- gallery -->
                        <li>
                            <a href="<?php echo e(route('ourDoctor')); ?>">Our Doctors</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Psychologist\resources\views/front-end/includes/header.blade.php ENDPATH**/ ?>